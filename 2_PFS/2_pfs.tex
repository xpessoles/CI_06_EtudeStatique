...
\usepackage[%
    pdftitle={Statique - Principe Fondamental de la Statique},
...
\begin{center}
 \LARGE\textsc{Chapitre 2 -- Principe Fondamental de la Statique -- PFS} 
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=3cm]{png/dae_renault} &
\includegraphics[height=5cm]{png/schema} \\
...
\textsc{Savoirs :}
\begin{itemize}
\item Isoler un système mécanique et faire l'inventaire des actions extérieures appliquées 
\item Appliquer le Principe Fondamental de la statique PFS
\item Théorème des actions réciproques
\end{itemize}
\end{savoir}
...
\begin{center}
\includegraphics[width=.8\textwidth]{png/3}
\end{center}
\end{minipage}
...
Deux outils outils permettent de modéliser un système en vu de la résolution d'un problème de statique : le schéma d'architecture et le graphe de structure. Ils permettent de traduire par des liaisons cinématiques chacun des contacts entre les différentes classes d'équivalence cinématiques d'un système.

\begin{center}
\includegraphics[width=\textwidth]{png/schema}
\textit{Schéma d'architecture}
\end{center}

\begin{center}
\includegraphics[width=\textwidth]{png/graphe}
...
\begin{center}
\includegraphics[width=.6\textwidth]{png/4}
\end{center}
...
\begin{center}
\includegraphics[width=.75\textwidth]{png/E}
\end{center}
$$
\torseurstat{T}{4}{3} 
= \torseurcol{X_{43}}{Y_{43}}{0}{0}{0}{0}{D,\mathcal{R}}
