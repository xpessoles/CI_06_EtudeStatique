...
\usepackage[%
    pdftitle={Statique - Modélisation des actions mécaniques},
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[height=3cm]{png/millau} &
\includegraphics[height=3cm]{png/millau2} &
\includegraphics[height=3cm]{png/millau3} \\
...
\textsc{Savoirs :}
\begin{itemize}
\item Actions mécaniques dans les contacts (définition d'une action mécanique, concept de force élémentaire et de moment d'un force élémentaire, résultante, moment, torseur représentant global d'une action mécanique)
\item Notion de tribologie (frottement de glissement, adhérence, résistance au roulement et au pivotement)
\end{itemize}
\end{savoir}
...
\begin{center}
\includegraphics[width=\textwidth]{png/verin2}
\end{center}
\end{minipage}\hfill
\begin{minipage}[c]{.6\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{png/verin1}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=.8\textwidth]{png/embrayage}
\textit{Embrayage de voiture}

\includegraphics[width=.8\textwidth]{png/zerog}
...
\begin{center}
\includegraphics[width=.5\textwidth]{png/local_global}
\end{center}
...
\begin{minipage}[c]{.3\linewidth}
\begin{center}
\includegraphics[width=.95\textwidth]{png/local}
\end{center}
\end{minipage}
\end{defi}
...
\begin{minipage}[c]{.3\linewidth}
\begin{center}
\includegraphics[width=.5\textwidth]{png/global}
\end{center}
\end{minipage}
\end{defi}
...
\begin{center}
\includegraphics[width=.6\textwidth]{png/clef}
\end{center}
...
\begin{exemple}
\textit{Calcul de masse d'un tore de petit rayon négligeable et de masse linéique $\mu$ (en $kg/m$)}

\includegraphics[width=.35\textwidth]{png/tore1}
...
\includegraphics[width=.2\textwidth]{png/spherique}
...
\includegraphics[width=.4\textwidth]{png/tore2}
...
\includegraphics[width=.2\textwidth]{png/disque}
...
\begin{center}
\includegraphics[width=\textwidth]{png/barrage}
\end{center}
\end{minipage}
\end{theo}
...
\vectm{G}{\text{Pres}}{S}=\vect{0}}{%
G}
=
\torseurl{%
\vectf{\text{Pres}}{S}=\iint\limits_{\mathcal{S}}p(M)\vect{n}d\mathcal{S}}{%
\vectm{O}{\text{Pres}}{S}=\vect{OM}\wedge p(M)\vect{n}d\mathcal{S}}{%
O}
$$
...
\includegraphics[width=.25\textwidth]{png/clavette}
\end{exemple}
...
\begin{minipage}[c]{.35\linewidth}
\begin{center}
\includegraphics[width=.9\textwidth]{png/bateau}
...
\begin{minipage}[c]{.35\linewidth}
\begin{center}
\includegraphics[width=.9\textwidth]{png/torsion}
...
\subsection{Torseur d'action dans les liaisons cinématiques}
\begin{center}
...
&
\begin{center}
\includegraphics[height=1.5cm]{png/annulaire}
...
&
\begin{center}
\includegraphics[height=2cm]{png/helico}
...
\begin{minipage}[c]{.35\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{png/cp}
\end{center}
\end{minipage}
\end{resultat}
...
Par ailleurs, en notant $f$ le coefficient de frottement entre les deux solides, on a la relation suivante :
$$
...
\begin{minipage}[c]{.35\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{png/coulomb}
\end{center}
\end{minipage}
\end{theo}
...
On note $\mu$ le coefficient d'adhérence entre les deux matériaux. On a alors : 
$$
...
\begin{minipage}[c]{.35\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{png/cone}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{.4\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{png/tanphi}
\end{center}
\end{minipage}
\end{rem}
...
\item $f$ coefficient de frottement.
\end{itemize}
\end{theo}
...
\subsubsection{Coefficient de frottement et de glissement}
...
Le coefficient de frottement ne dépend pas de la pression de contact entre deux solides.

\begin{center}
\begin{tabular}{|c||c|c||c|c|}
\hline
\multirow{2}{*}{Matériaux} 
& \multicolumn{2}{c||}{Coefficient d'adhérence} & \multicolumn{2}{c|}{Coefficient de frottement} \\
\cline{2-5}
