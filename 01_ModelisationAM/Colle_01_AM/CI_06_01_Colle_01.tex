...
$$
dm =\mu  d\mathcal{V}= \mu \rho d\theta d\rho dz
$$
\begin{itemize}
...
$$
m = \mu \int\limits_{0}^{r} \int\limits_{0}^{2\pi} \int\limits_{0}^{\rho \dfrac{h}{r}} \rho dz d\theta d\rho
= \mu \int\limits_{0}^{r} \int\limits_{0}^{2\pi} \rho^2 \dfrac{h}{r}  d\theta d\rho 
= \mu \dfrac{h}{r}\dfrac{r^3}{3}2\pi
= \mu \dfrac{hr^2}{3}2\pi
$$
