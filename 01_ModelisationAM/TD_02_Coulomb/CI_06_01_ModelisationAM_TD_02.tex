...
\section*{Exercice 1 : Assemblage par frettage}
...
\item $f$ coefficient d’adhérence entre les deux pièces.
\end{itemize}
...
\begin{minipage}[c]{.4\linewidth}
\begin{center}
\includegraphics[width=.9\textwidth]{images/fig_03}
\end{center}
\end{minipage}
...
\section*{Exercice 2 : Embrayage à friction monodisque de véhicules automobiles (surfaces de friction plane)}
...
\section{Exercice 3 : Embrayage conique des synchroniseurs de boite de vitesses (surface de friction coniques)} 
